...
class User extends Admin_Controller {
    ...
    public function edit($user_id = NULL) {
        ...
        $user_id || $rules['password']['rules'] .= '|required';
    ...
    public function login(){
        ...
        $this->user_m->logged_in() == FALSE || redirect('admin/dashboard');
    ...
    public function _unique_email ($str)
    {
        ...
        if (count($user)) {
            $this->form_validation->set_message('_unique_email', 'The {field} should be unique.');
            return FALSE;
        }else {
            return TRUE;
        }
